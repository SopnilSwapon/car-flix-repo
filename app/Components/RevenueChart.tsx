...
//   cy?: number;
//   r?: number;
//   chartBottom: number;   // <- we inject this
//   stripWidth?: number;   // <- optional width
// };

// // Draw the shaded strip from the point (cy) down to the x-axis (chartBottom),
// // then draw the active dot on top.
// function ActiveDot({
//   cx,
//   cy,
//   r = 6,
...
//     height={height}
//     rx={6}
//     fill="url(#hoverGradient)" // reference the gradient
//   />
...
//     { name: "Mar", uv: 170 },
//     { name: "Apr", uv: 110 },
//     { name: "May", uv: 180 }, // screenshot month
//     { name: "Jun", uv: 120 },
//     { name: "Jul", uv: 40 },
//     { name: "Aug", uv: 50 },
//     { name: "Sep", uv: 200 },
...
//   // keep these in sync with <LineChart margin> and <ResponsiveContainer height>
//   const CHART_HEIGHT = 260;
//   const MARGIN = { top: 16, right: 24, left: 8, bottom: 8 };
//   const CHART_BOTTOM = CHART_HEIGHT - MARGIN.bottom; // bottom of plotting area
...
//           <Tooltip
//             cursor={false} // disable default full-height cursor
//             formatter={(v: number) => [`$${v}`, "This Month", ]}
...
//             strokeWidth={3}
//             dot={{ r: 3 }}
//             // Our custom activeDot draws the vertical shaded strip + dot
