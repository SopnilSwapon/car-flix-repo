...
const StatCard: React.FC<IStatCard> = ({
  ...
  return (
    <div className="w-full rounded-2xl border border-gray-200 bg-white p-5 shadow-sm flex flex-col justify-between">
      {/* Top Section */}
  ...
  <TrendingUp className="text-[#4CAF50]" /> <span className="text-[16px]">6 %</span>
        </div>
